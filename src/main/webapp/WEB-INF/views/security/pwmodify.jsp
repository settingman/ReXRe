...
<meta name="description" content="현대백화점 그룹의 천연원료전문기업인 현대바이오랜드에서 만든 비건 뷰티 브랜드. 
콤부차토너, 수분앰플, 장벽크림, 약산성폼, 진정마스크 출시">
<meta property="og:site_name" content="클린 &amp; 비건 뷰티 브랜드 리바이리 ">
<meta property="og:url" content="https://www.rexremall.com/member/edit_step1.php">
...
<meta property="og:image" content="https://skbiolandmall.wisacdn.com/_data/banner/seo/aca9ec01c76b8eca3c6456d4c046bd53.JPG">
...
<link rel="stylesheet" type="text/css" href="https://www.rexremall.com/wm_engine_SW/_engine/common/loading.css??202212301739">
...
var hid_frame='hidden1672389566';
var mlv='9';
var alv='';
var root_url='https://www.rexremall.com';
var engine_url='https://www.rexremall.com/wm_engine_SW';
var this_url='https://www.rexremall.com/member/edit_step1.php';
...
click_prd[1]="<a href=\"https://www.rexremall.com/shop/detail.php?pno=076A0C97D09CF1A0EC3E19C7F2529F2B&cno1=1001\"><img src=\"https://skbiolandmall.wisacdn.com/_data/product/202208/22/2a81785d3198690a505a063c87217b3a.jpg\" width=\"51\" height=\"62\" alt=\"리바이리 콤부차 배리옴 베이직 2종 기획 (토너/폼클렌저)-56,000\" title=\"\"></a>";
...
<script type="text/javascript" src="https://www.rexremall.com/wm_engine_SW/_engine/common/common.js?202212301739"></script>
<script type="text/javascript" src="https://www.rexremall.com/wm_engine_SW/_engine/common/shop.review.js?202212301739"></script>
...
</script><script src="https://cdn.megadata.co.kr/js/socialLink/social_sns_config_min.js" type="text/javascript" defer="" async=""></script></head>
...
<iframe name="hidden1672389566" src="about:blank" width="0" height="0" scrolling="no" frameborder="0" style="display:none"></iframe>

<script language="JavaScript" type="text/javascript" src="https://www.rexremall.com/wm_engine_SW/_engine/common/member.js"></script>
...
<!--
#skin_member_edit_step1_big_div{width:100%;}
-->
</style>
<div id="skin_member_edit_step1_big_div">
...
<i id="crema-login-username" style="display:none;">joilwoo</i>
<i id="crema-login-name" style="display:none;">조일우</i>
<div id="wrapper">
	<!-- 상단 -->
	<div id="sub_hd" class="">
		<div class="header">
	<div class="gnb">
		...
		-->
		<div class="inner">
			<h1><a href="/"><img src="https://www.rexremall.com/_skin/skbioland_200731/img/logo/logo_rexre.png" alt="클린 &amp; 비건 뷰티 브랜드 리바이리 "></a></h1>
			<div class="lnb">
				<span class="all" onclick="toggle_view('all_cate', this);">all</span>
				<ul class="category">
					<li><a href="/shop/big_section.php?cno1=1009">NEW&amp;BEST</a></li>
					<li class="viewsub product">
...
<li class="txt first"><a href="/mypage/mypage.php">조일우님(Silver회원)</a></li>
...
<!-- //gnb 로그인 메뉴부분에 사용됩니다. 삭제시 문제가 발생할 수 있습니다. -->
				...
				<li><a href="/shop/cart.php" class="cart">장바구니 <span class="ea_cart front_cart_rows quick_cart_cnt">3</span><span class="balloon">장바구니</span></a></li>
		...
		<div id="all_cate" class="all_cate">
			<div class="inner">
				<dl class="product">
					<dt><a href="/shop/big_section.php?cno1=1012">PRODUCT</a></dt>
					<dd>
...
<ul><li><a href="https://www.rexremall.com/shop/big_section.php?cno1=1026">건성</a></li>
	...
	<li><a href="https://www.rexremall.com/shop/big_section.php?cno1=1030">주름개선</a></li>
				...
				<dl class="event">
					<dt><a href="/board/?db=gallery_1&amp;cate=17">EVENT</a></dt>
					<dd><a href="/board/?db=gallery_1&amp;cate=17">진행중인 이벤트</a></dd>
					<dd><a href="/board/?db=gallery_1&amp;cate=18">종료된 이벤트</a></dd>
					<dd><a href="/board/?db=basic_3">당첨자발표</a></dd>
				</dl>
				<dl class="community">
					<dt><a href="/board/?db=basic_1">COMMUNITY</a></dt>
					<dd><a href="/board/?db=basic_4">공지사항</a></dd>
					<dd><a href="/board/?db=gallery_2">미디어</a></dd>
					<!--<dd><a href="/content/content.php?cont=benefit">회원혜택</a></dd>-->
					<dd><a href="/board/?db=basic_2">쇼핑FAQ</a></dd>
					<dd><a href="/mypage/counsel_list.php">1:1문의</a></dd>
				</dl>
				<dl class="brand">
					<dt><a href="/content/content.php?cont=brand_n">BRAND</a></dt>
					<dd><a href="/content/content.php?cont=brand_n">브랜드 스토리</a></dd>
					<dd><a href="/content/content.php?cont=bi">BI</a></dd>
				</dl>
...
<div id="mypage_menu">
	<ul>
		<li>
			<dl>
				<dt>주문관리</dt>
				<dd><a href="/mypage/order_list.php">주문/배송조회</a></dd>
			</dl>
		</li>
		<li>
			<dl>
				<dt>나의 혜택</dt>
				<dd><a href="/mypage/coupon_down_list.php">쿠폰북</a></dd>
				<dd class="dnY"><a href="/mypage/milage.php">적립금</a></dd>
				<dd class="dn"><a href="/mypage/emoney.php">예치금</a></dd>
				<dd><a href="/mypage/sccoupon.php">소셜 쿠폰</a></dd>
			</dl>
		</li>
		<li>
			<dl>
				<dt>상품관리</dt>
				<dd><a href="/mypage/wish_list.php">위시리스트</a></dd>
				<dd><a href="/shop/cart.php">장바구니</a></dd>
				<dd><a href="/shop/click_prd.php">최근 본 상품</a></dd>
			</dl>
		</li>
		<li>
			<dl>
				<dt>나의 활동</dt>
				<dd><a href="/mypage/review_list.php">상품후기</a></dd>
				<dd><a href="/mypage/qna_list.php">상품 Q/A</a></dd>
				<dd><a href="/mypage/counsel_list.php">1:1 문의</a></dd>
				<dd style="display:none;"><a href="/mypage/attend_list.php">출석체크</a></dd>
			</dl>
		</li>
		<li>
			<dl>
				<dt>나의 정보</dt>
				<dd><a href="/member/edit_step1.php">개인정보 수정</a></dd>
				<dd><a href="/mypage/withdraw_step1.php">회원 탈퇴</a></dd>
				<dd class="dnY"><a href="/mypage/notify_restock.php">재입고 알림 신청 내역</a></dd>
			</dl>
		</li>
	</ul>
</div>
...
<div id="edit_pw" class="edit_info">
	...
	<form method="post" action="https://www.rexremall.com/main/exec.php" onsubmit="return checkEditStep1(this)" target="hidden1672389566" style="margin:0px;">
<input type="hidden" name="exec_file" value="member/edit_step1.exe.php">

		<div class="box">
			<p class="msg">고객님의 안전한 정보보호를 위하여 비밀번호를 다시 한번 확인합니다.<br>비밀번호가 타인에게 노출되지 않도록 주의하여 주세요.</p>
		...
		<div class="btn">
			...
			<span class="box_btn w150 large white"><a href="javascript:history.back();">취소</a></span>
		</div>
	</form>
</div><!-- mkt script '모비온' scr_bottom start-->
...
<!--mkt script '모비온' scr_bottom end-->
	...
	<div class="inner">
		<div class="shopinfo">
			...
			<!-- 쇼핑몰정보 및 에스크로 -->
			<address class="info">
				<span>(주)현대바이오랜드</span><span>대표자 이희준</span><span>고객센터 1522-1378</span><span>개인정보보호책임자 김정은</span><span>이메일주소 <a href="mailto:bnh@hyundaibioland.co.kr">bnh@hyundaibioland.co.kr</a></span><span class="last">사업자등록번호 312-81-24525 <span class="link"><a href="#" onclick="wisaOpen(&quot;http://www.ftc.go.kr/info/bizinfo/communicationViewPopup.jsp?wrkr_no=3128124525&quot;,&quot;biz_check_frame&quot;,&quot;yes&quot;,&quot;780&quot;,&quot;928&quot;); return false;">사업자정보확인</a></span></span><br>
				<span>주소 충청북도 청주시 흥덕구 오송읍 오송생명2로 22 주식회사 현대바이오랜드</span><span class="last">통신판매업 신고번호 제2022-충북청주-1145호</span>
				&nbsp;&nbsp;&nbsp;<span class="last">고객님은 안전거래를 위해 현금으로 결제 시 저희 쇼핑몰에 가입한 구매 안전 서비스를 이용하실 수 있습니다. <span class="link"><a href="javascript:goValidEscrow('ws_hyeondaedd');">서비스 가입사실 확인</a></span></span>
			</address>
			<!-- //쇼핑몰정보 및 에스크로 -->
			<p class="copyright"> © 2022 <strong>HYUNDAI BIOLAND </strong> ALL RIGHTS RESERVED. <a href="http://by.wisa.co.kr/www.rexremall.com" target="_blank" alt="위사 호스팅" title="위사 호스팅">
			 &nbsp; &nbsp; managed &amp; hosted by   WISA.</a></p>
		</div>
		<ul class="sns">
			<li><a href="https://www.facebook.com/officialrexre/" target="_blank" class="fb">facebook</a></li>
			<li><a href="http://pf.kakao.com/_xjFMxbT" target="_blank" class="kakao">kakaotalk</a></li>
			<li><a href="https://www.instagram.com/rexre.official" target="_blank" class="insta">instagram</a></li>
		</ul>
	</div>
</div>
	</div>
...
<script src="https://developers.kakao.com/sdk/js/kakao.min.js"></script>
						<script type="text/javascript">Kakao.init('35f0e015717743bf7c71437e8faf25bd');</script><script type="text/javascript">
	if(typeof wcs != 'undefined') {
...
<iframe scrolling="no" id="iframe_mbris_bounce_section" style="width: 100%; height: 0px; border: none; opacity: 0;"></iframe></div></body></html>