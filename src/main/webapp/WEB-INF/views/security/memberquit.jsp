...
<meta property="og:url" content="https://www.rexremall.com/mypage/withdraw_step1.php">
...
<link rel="stylesheet" type="text/css" href="https://www.rexremall.com/wm_engine_SW/_engine/common/loading.css??202212301744">
...
var hid_frame='hidden1672389842';
var mlv='9';
var alv='';
var root_url='https://www.rexremall.com';
var engine_url='https://www.rexremall.com/wm_engine_SW';
var this_url='https://www.rexremall.com/mypage/withdraw_step1.php';
...
<script type="text/javascript" src="https://www.rexremall.com/wm_engine_SW/_engine/common/common.js?202212301744"></script>
<script type="text/javascript" src="https://www.rexremall.com/wm_engine_SW/_engine/common/shop.review.js?202212301744"></script>
...
<iframe name="hidden1672389842" src="about:blank" width="0" height="0" scrolling="no" frameborder="0" style="display:none"></iframe>
...
<!--
#skin_mypage_withdraw_step1_big_div{width:100%;}
-->
</style>
<div id="skin_mypage_withdraw_step1_big_div">
...
<i id="crema-login-username" style="display:none;">dhfkddnxks123</i>
<i id="crema-login-name" style="display:none;">오랑이</i>
<div id="wrapper">
	<!-- 상단 -->
	<div id="sub_hd" class="">
...
<li class="txt first"><a href="/mypage/mypage.php">오랑이님(Silver회원)</a></li>
...
<div id="draw_input" class="withdraw">
	...
	<form method="post" action="https://www.rexremall.com/main/exec.php" target="hidden1672389842" onsubmit="return checkDraw(this)" style="margin:0px;text-align:center;">
<input type="hidden" name="exec_file" value="mypage/withdraw.exe.php">
		...
		<div class="box">
			...
			<div class="frame">
				...
				<textarea name="content" id="withdraw_step1_cnt" class="form_input block" placeholder="탈퇴사유"></textarea>
			</div>
		</div>
		<div class="btn">
...
<div id="mbris_bounce_section" style="height: 0px; z-index: 100000; visibility: hidden; overflow: hidden;"><iframe scrolling="no" id="iframe_mbris_bounce_section" style="width: 100%; height: 0px; border: none; opacity: 0;"></iframe></div></body></html>