							...
							<fieldset>
								...
								<div class="box" style="padding-bottom: 20px; border-bottom: 3px solid #000;">
									...
									<div class="sex">
										<label>성별</label>
										<div class="select sl">
											<input type="radio" name="sex" value="남" id="sex_male" required="required">
							...
							<fieldset>
								...
								<div class="box" style="padding-bottom: 20px; border-bottom: 3px solid #000;">
									<div>
										<label for="join_id">아이디</label>
										<p class="addbtn">
											<input type="text" name="member_idid" value="<sec:authentication property="principal.member.useridid"/>" maxlength="16" readonly id="join_id" class="form_input block" placeholder="아이디">
										</p>
									</div>
									...
									<div>
										<label for="join_name">이름</label>
										<input type="text" name="member_name" readonly value="<sec:authentication property="principal.member.userName"/>" id="join_name" class="form_input block" placeholder="이름" required="required">
									</div>
									...
									<div>
										<label for="join_cell">휴대전화번호</label>
										<input type="text" name="member_phone" value="<sec:authentication property="principal.member.member_phone"/>" id="join_cell" class="form_input block remove_dash" placeholder="휴대전화번호" required="required">
									</div>
									<div class="email">
										<label for="join_email">이메일</label>
										<input type="text" name="email1" value="<sec:authentication property="principal.member.useridid"/>" id="join_email" class="form_input first" placeholder="이메일" required="required">
										<span>@</span>
										<input type="text" name="email2" value="" class="form_input second" id="email2" isplaceholderinited="true" required="required">
										<select name="email3" onchange="chgEmail(this.form.email2,this,'')">
											<option value="">이메일 선택</option>
									...
									<div class="addr">
										<label for="join_address">주소</label>
										<p class="addbtn">
											<input type="text" name="zip" value="<sec:authentication property="principal.member.member_postNum"/>" id="join_address" class="form_input block" readonly="" placeholder="우편번호" required="required">
											<span class="box_btn w115 h50 gray light fs15 kor"><a id="address_kakao">우편번호 검색</a></span>
										</p>
										<input type="text" name="addr1" value="<sec:authentication property="principal.member.member_address1"/>" maxlength="50" class="form_input middle_address block" readonly="" placeholder="기본주소" id="addr1" required="required">
										<input type="text" name="addr2" value="<sec:authentication property="principal.member.member_address2"/>" maxlength="100" class="form_input block" placeholder="나머지 주소" required="required">
									</div>
									<div class="allergy">
										<label for="join_allergy">알러지</label>
										<input type="text" name="allergy" value="" id="join_allergy" class="form_input block" placeholder="알러지">
