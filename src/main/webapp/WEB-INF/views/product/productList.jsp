...
<link rel="stylesheet" type="text/css" href="https://www.rexremall.com/wm_engine_SW/_engine/common/loading.css??202212301607">
...
<script type="text/javascript" src="https://www.rexremall.com/wm_engine_SW/_engine/common/common.js?202212301607"></script>
<script type="text/javascript" src="https://www.rexremall.com/wm_engine_SW/_engine/common/shop.review.js?202212301607"></script>
...
<body>
	<input type='hidden' name='category' class='category' value='${productCategory}'>
	<iframe name="hidden1672384053" src="about:blank" width="0" height="0" scrolling="no" frameborder="0" style="display: none"></iframe>
					...
					<div id="big_section">
						<div class="wrap_inner">
							<ul class="sub_category">
								<li class="mid_code cate_1012"><a href="${contextPath}/product/productList?pageNum=1&amount=9">PRODUCT</a></li>
								<li class="cate_1020"><a href="${contextPath}/product/productCategory?productCategory=마스크팩&pageNum=1&amount=9">마스크팩</a></li>
								<li class="cate_1021"><a href="${contextPath}/product/productCategory?productCategory=스킨케어&pageNum=1&amount=9">스킨케어</a></li>
							</ul>
							<!-- 상품정렬 -->
...
<!-- 								<div class="sort">
									...
									<li><div class="box ">
											<div class="img">
												<div class="prdimg img1226">
													<sec:authorize access="isAnonymous()">
														<a href="/product/productDetail?productId=${productList.productId}" tabindex="-1">
													</sec:authorize>
													<sec:authorize access="isAuthenticated()">
														<a href="/product/productDetailid?productId=${productList.productId}&member_idid=${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}" tabindex="-1">
													</sec:authorize>
													<img src="<c:out value='${productList.imagePath}'/>" width="380" height="466">
													</a>
												</div>
												<!-- 상품품절 영역 -->
												<div class="soldout"
											...
											<div class="info">
												<ul class="quick" style="display: none;">
													<li class="preview"><a href="javascript:quickDetailPopup(this, 596, '1012');">상품팝업</a></li>
													<li class="wish"><a href="#" onclick="wishPartCartAjax(&quot;B2EEB7362EF83DEFF5C7813A67E14F0A&quot;, this); return false;">관심상품 담기</a></li>
													<li class="cart"><a href="#" onclick="cartPartCartAjax(&quot;B2EEB7362EF83DEFF5C7813A67E14F0A&quot;, &quot;리바이리 콤부차 배리옴 스킨케어 5종 기획&quot;, &quot;170,000&quot;); return false;">장바구니
															담기</a></li>
												</ul>
												...
												<div class="price">
													<div class="price_boxY">
														<p class="consumer dn">
															<fmt:formatNumber value="${productList.productPrice}" pattern="#,###" type="number" />
														</p>
														<p class="sell">
															<strong> <fmt:formatNumber value="${productList.productPrice}" pattern="#,###" type="number" /></strong>원
														</p>
													</div>
													<div class="price_box">
							...
							<ul class="paging">
								<c:if test="${pageMaker.prev}">
									<li class="paginate_button previous"><a href="${pageMaker.firstPage}"> << </a> <a href="${pageMaker.startPage - 1}">이전</a></li>
								</c:if>
								<!-- number -->
								<c:forEach var="num" begin="${pageMaker.startPage}" end="${pageMaker.endPage }">
									<li class="paginate_button ${pageMaker.cri.pageNum == num ? "action" : "" }"><a style="font-weight: bold; margin: 3px;" class="pageNutton"
										href="/product/productList?pageNum=${num}&amount=9" id="buttonurl${num}" data-num="${num}"}>${num}</a></li>
									<input type='hidden' name='num' id='num' value='${pageMaker.startPage}'>
								</c:forEach>
								<c:if test="${pageMaker.next}">
									<li class="pageinate_button next"><a href="${pageMaker.endPage + 1}"></a></li>
								</c:if>
								<!-- <li></li>
							...
							<form id='actionFrom' action="/product/productList" method="get">
								<input type='hidden' name='pageNum' value='${pageNum.cri.pageNum}'> <input type='hidden' name='amount' value='${pageNum.cri.amount }'>
							</form>
							<!-- End Pagination -->
						</div>
						<script type="text/javascript">
...
window.criteo_q.push(
	...
	{"event":"viewList","item":["B2EEB7362EF83DEFF5C7813A67E14F0A","076A0C97D09CF1A0EC3E19C7F2529F2B","FDE9264CF376FFFE2EE4DDF4A988880D"]});
		...
		<span itemscope="" itemtype="http://schema.org/Organization">
			<link itemprop="url" href="https://www.rexremall.com"> <a itemprop="sameAs" href="https://www.facebook.com/officialrexre/"></a> <a itemprop="sameAs" href="https://pf.kakao.com/_xjFMxbT"></a>
