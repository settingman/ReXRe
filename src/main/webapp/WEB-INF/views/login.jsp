						...
						<form method="post" action="login" style="margin: 0px">
							...
							<fieldset class="login_field">
								...
								<div class="savessl">
									...
									<input type="checkbox" name="setOpenSSL" id="member_ssl" checked onclick="return false;" style="margin-left:20px;">
									<label style="font-size: 13px;" for="member_ssl">로그인 유지</label>
								</div>
