				...
				<div class="cntbody">
					...
					<div id="cart">
						<form name="cartFrm" method="post" action="https://www.rexremall.com/main/exec.php" target="hidden1672195870" style="margin: 0px">
								...
								<tbody class="test">
									...
									<c:forEach var="cartItem" items="${cartItems}" varStatus="status">
										<tr class="checked" id="itemNum${status.count}" >
											...
											<td class="qty">
												<div class="box_qty">
													<input type="text" name="buy_ea[]" value="${cartItem.CART_QUANTITY}" id="buy_ea${status.count}" class="form_input" isplaceholderinited="true" />
													<div class="btn_ea">
														<a href="#" onclick="updateQuantity(${cartItem.PRODUCT_ID}, ${cartItem.CART_QUANTITY}, <sec:authentication property="principal.member.userid"/>, 1,${status.count}); return false;" class="ea_up" id="${status.count}"></a> <a href="#" onclick="updateQuantity(${cartItem.PRODUCT_ID}, ${cartItem.CART_QUANTITY}, <sec:authentication property="principal.member.userid"/>, -1,${status.count}); return false;" class="ea_down" id="${status.count}"></a>
													</div>
												</div>
											...
											<td class="prc cart_prc">
												...
												</p> <input type="hidden" class="og_price" id="og_price${status.count}" value="${cartItem.PRODUCT_PRICE}"> <input type="hidden" class="product_id" id="product_id${status.count}" value="${cartItem.PRODUCT_ID}">
												<p id="item_p">
													<strong></strong>
												</p>
											</td>
											<td class="prc"></td>
											<td class="delete_wish"><span class="box_btn w79 h29 gray fs13 light kor"><a href="#" onclick="deleteCartOne(${cartItem.PRODUCT_ID}, ${status.count}, <sec:authentication property="principal.member.userid"/>); return false;">삭제</a></span></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
							...
							<div class="btn">
								<div class="left">
									<span class="box_btn w117 h45 fs15 kor white"><a href="#" class="selectDelete_btn">선택삭제</a></span> <span class="box_btn w117 h45 fs15 kor white"><a onclick="deleteAllCartAjax2();">장바구니 비우기</a></span>
								</div>
								<div class="right">
									<span class="box_btn w117 h45 fs15 kor white"><a href="https://www.rexremall.com/shop/big_section.php?cno1=1020">계속 쇼핑하기</a></span> <span class="box_btn w117 h45 fs15 kor"><a href="#" class="selectOrder_btn">선택상품 주문</a></span>
								</div>
							</div>
							<!-- //장바구니 버튼 -->
							<div class="box">
								...
								<dl class="total">
									...
									<dd>
										<strong><span id="total_order_price_cartlist" class="price total_order_price_cartlist"></span>원 </strong>
									</dd>
								</dl>
							</div>
							<div class="bottom_btn tac">
								<span class="box_btn w180 h65 fs17 kor"><a href="#" class="selectOrder_btn">상품 주문하기</a></span>
							</div>
