...
<script type="text/javascript">
      ...
      click_prd[1] =
        '<a href="https://www.rexremall.com/shop/detail.php?pno=58D4D1E7B1E97B258C9ED0B37E02D087&cno1=1001"><img src="https://skbiolandmall.wisacdn.com/_data/product/202208/08/9d67faf5de5906f682b3bb52fef7a3dc.jpg" width="51" height="62" alt="리바이리 콤부차 배리옴 릴리프 마스크 1매-6,500" title=""></a>';
      click_prd[2] =
        '<a href="https://www.rexremall.com/shop/detail.php?pno=B2EEB7362EF83DEFF5C7813A67E14F0A&cno1=1001"><img src="https://skbiolandmall.wisacdn.com/_data/product/202208/22/d52eed1ad2c623bd89d0363b846c1365.jpg" width="51" height="62" alt="리바이리 콤부차 배리옴 스킨케어 5종 기획-170,000" title=""></a>';
...
<script type="text/javascript">
      var date_picker_default = {
        ...
        dayNamesMin: [
          _lang_pack.data_week_sun,
          _lang_pack.data_week_mon,
          _lang_pack.data_week_tue,
          _lang_pack.data_week_wed,
          _lang_pack.data_week_thu,
          _lang_pack.data_week_fri,
...
<body>
	...
	<script type="text/javascript">
      function doPay_ActiveX() {
        lgdwin = openXpay(
          document.getElementById("LGD_PAYINFO"),
          "service",
          "iframe",
          null,
          "",
      ...
      function payment_return() {
        ...
        if (fDoc.document.getElementById("LGD_RESPCODE").value == "0000") {
          document.getElementById("LGD_PAYKEY").value =
            fDoc.document.getElementById("LGD_PAYKEY").value;
          ...
          document.getElementById("LGD_PAYINFO").action =
            "https://www.rexremall.com/main/exec.php?exec_file=card.dacom/XpayNon/card_pay.exe.php";
      ...
      function cancelXPay(res_cd, res_msg, alert_msg) {
        ...
        $.post(
          "/main/exec.php?exec_file=order/pay_cancel.php",
          { ono: ono, reason: res_msg },
          function (r) {
            if (r == "stat") {
	...
	<form name="mainForm" method="post" id="LGD_PAYINFO">
		...
		<!-- 첫번째 결제수단 -->
		<input type="hidden" name="LGD_INSTALLRANGE" value="" />
		<!-- 신용카드 할부 -->
		...
		<input type="hidden" name="LGD_CASNOTEURL"
			value="https://www.rexremall.com/main/exec.php?exec_file=card.dacom/XpayNon/card_pay.exe.php" />
		<!-- 무통장 결제결과처리_URL(LGD_NOTEURL) -->
		<input type="hidden" name="LGD_ESCROW_USEYN" value="N" />
		<!-- 에스크로 적용 여부 -->
		<input type="hidden" name="LGD_TAXFREEAMOUNT" value="0" />
		<!-- //면세금액/ -->
		<input type="hidden" name="LGD_NOINTINF" id="LGD_NOINTINF" value="" />
		<input type="hidden" name="LGD_CASHRECEIPTYN" id="LGD_CASHRECEIPTYN"
			value="" /> <input type="hidden" name="LGD_WINDOW_VER" value="2.5" />
		<!-- 결제창버전정보 (삭제하지 마세요) -->
		<input type="hidden" name="LGD_VERSION" value="" />
		<!-- 버전정보 (삭제하지 마세요) -->
...
<div id="shopback-app"
	...
	<div id="DisableNotifier"></div>
	<div id="PermissionNotifier"></div>
</div>
</html>
