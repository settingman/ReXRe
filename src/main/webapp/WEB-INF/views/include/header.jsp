               ...
               <div class="gnb">
                  ...
                  <div class="inner">
                     ...
                     <div class="lnb">
                        ...
                        <ul class="category">
                           <li><a href="${contextPath}/product/productNewBest?pageNum=1&amount=9">NEW&amp;BEST</a>
                           </li>
                           <li class="viewsub product"><a
                              href="${contextPath}/product/productList?pageNum=1&amount=9">PRODUCT</a>
                              <div class="list">
                                 <ul class="mid_depth">
                                    <li><a
                                       href="${contextPath}/product/productCategory?productCategory=마스크팩&pageNum=1&amount=9">마스크팩</a>
                                    </li>
                                    <li><a
                                       href="${contextPath}/product/productCategory?productCategory=스킨케어&pageNum=1&amount=9">스킨케어</a>
                                    </li>
                                 </ul>
