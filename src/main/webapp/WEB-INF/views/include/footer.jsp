			...
			<div class="shopinfo">
				...
				<address class="info">
					...
					<span>주소 충청북도 청주시 흥덕구 오송읍 오송생명2로 22 주식회사 현대바이오랜드</span><span
						class="last">통신판매업 신고번호 제2022-충북청주-1145호</span> &nbsp;&nbsp;&nbsp;<span
						class="last">고객님은 안전거래를 위해 현금으로 결제 시 저희 쇼핑몰에 가입한 구매 안전 서비스를
						이용하실 수 있습니다. <span class="link"><a
							href="javascript:goValidEscrow('ws_hyeondaedd');">서비스 가입사실 확인</a></span>
					</span>
				</address>
				<!-- //쇼핑몰정보 및 에스크로 -->
				<p class="copyright">
